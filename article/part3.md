...
Creating a structured and functionally pure framework for memoization fixes all of these.
...
The hardest part about effective memoization is writing the correct resolver functions. It's helpful to think of a resolver function as an entity that finds nodes in the state tree, by traversing it.
...
Targeting the `docs` node is much better.
